 ...
 */
export function Toolbar({ className, density = "comfortable", surface = "inline", ...rest }: ToolbarProps) {
  return (
    <div
      role="toolbar"
      className={cn(
        ...
        surface === "floating" && "rounded-md border border-border bg-card px-1 py-0.5 shadow-lg",
        className
      )}
      {...rest}
    />
